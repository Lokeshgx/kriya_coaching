/**
 * Base Template Loader (moved to js/)
 * This script automatically includes common head content and scripts from pages/ partials
 * Include this in the <head> early and call loadCommonScripts() before </body> to load common-scripts.html
 */
